...
public class EventCalendarView extends RelativeLayout implements OnItemClickListener,
	OnClickListener{
    ...
    private HashMap<Integer, HashMap<Integer,Event>> monthEventMap = new HashMap<>();
	...
	private void init(){
		...
		mAdapter = new CalendarAdapter(context,cal,monthEventMap.get(cal.get(Calendar.MONTH)));
	...
	public void refreshCalendar(){
		mAdapter.refreshDays(monthEventMap.get(cal.get(Calendar.MONTH)));
		mAdapter.notifyDataSetChanged();
	}

    public void setMonthEventMap(HashMap<Integer, HashMap<Integer, Event>> newMap) {
        monthEventMap = newMap;
    }
	/**
	 * 
	 * @param color
	 ...
	 */
	public void setPreviousMonthButtonImageResource(int resource) { prev.setImageResource(resource); }
	 ...
	 */
	public void setNextMonthButtonImageResource(int resource) { next.setImageResource(resource); }
